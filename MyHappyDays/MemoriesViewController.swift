...
class MemoriesViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UICollectionViewDelegateFlowLayout, AVAudioRecorderDelegate {
    ...
    func saveNewMemory(image: UIImage) {
        ...
        // use the unique name to create filename for the full size image and the thumbnail
        ...
        do {
            ...
            // convert the UIImage into a JPEG dat object
    ...
    func indexMemory(memory: URL, text: String) {
        ...
        let item = CSSearchableItem(uniqueIdentifier: memory.path, domainIdentifier: "com.daxapps", attributeSet: attributeset)
